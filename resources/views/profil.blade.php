...
<div class="profil-section">
    <div class="profil-card">
        ...
        <h2>Diki</h2>
        <div class="email">diki@email.com</div>
        ...
        <hr class="divider">
        <div class="info-row"><span>Nama Lengkap</span><span>Diki</span></div>
        <div class="info-row"><span>Email</span><span>diki@email.com</span></div>
